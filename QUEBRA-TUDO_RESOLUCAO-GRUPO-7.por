programa {
  ...
  funcao AcidentesTransito(){
    ...
    real maior_indice_acidentes = 0, menor_indice_acidentes = 100, media_car, media_acidente = 0, indices[3], soma_acidente = 0
    inteiro cidade_maior_indice, cidade_menor_indice, tot_car = 0, cidade_menos_car = 0, qtd_carro[3], numero_acidentes[3]
    inteiro codigos[3]
    ...
    para(inteiro i = 0; i < 3; i++) {
      ...
      indices[i] = mat.arredondar((numero_acidentes[i] / qtd_carro[i]), 1)
    ...
    media_acidente = mat.arredondar((soma_acidente / cidade_menos_car), 1) //media de acidentes nas cidades com menos de 2000 carros
    media_car = tot_car / 3
    ...
    escreva("\nCom base em todas as cidades a media de veiculos é ", mat.arredondar(media_car, 1),".")
